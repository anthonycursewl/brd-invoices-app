export default function IconQr() {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <rect
          ...
          strokeLinejoin="round"
        ></rect>{" "}
        <rect x="6" y="10" width="2" height="2" rx="0.5" fill="#5cedf0"></rect>{" "}
        <path
          ...
          fill="#5cedf0"
        ></path>{" "}
        <rect x="8" y="12" width="4" height="2" rx="0.5" fill="#5cedf0"></rect>{" "}
        <rect x="18" y="10" width="4" height="2" rx="0.5" fill="#5cedf0"></rect>{" "}
        <rect x="12" y="18" width="4" height="2" rx="0.5" fill="#5cedf0"></rect>{" "}
        <rect x="10" y="16" width="2" height="2" rx="0.5" fill="#5cedf0"></rect>{" "}
        <path
